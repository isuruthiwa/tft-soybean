...
import data_formatters.soybean
...
class ExperimentConfig(object):
  ...
  default_experiments = ['volatility', 'electricity', 'traffic', 'favorita', 'soybean']
  ...
  def data_csv_path(self):
    csv_map = {
        ...
        'soybean': 'soybean_soil_filtered.csv'
    }
  ...
  def make_data_formatter(self):
    ...
    data_formatter_class = {
        ...
        'soybean': data_formatters.soybean.SoybeanFormatter
    }
