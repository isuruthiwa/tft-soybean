"""Custom formatting functions for Soybean dataset provided by saeedkhaki92.
...
class SoybeanFormatter(GenericDataFormatter):
    """Defines and formats data for the soybean dataset.
